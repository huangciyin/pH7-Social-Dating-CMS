...
class DynamicFieldCoreForm
{
    ...
    public function generate()
    {
        switch ($this->_sColumn) {
            ...
            case 'state':
                $this->_oForm->addElement(new \PFBC\Element\Textbox(t('Your State or Province:'), $this->_sColumn, array('id'=>$this->getFieldId('str'), 'onblur' =>'CValid(this.value,this.id,2,150)','value' => $this->_sVal, 'validation'=>new \PFBC\Validation\Str(2,150), 'required'=>1)));
                $this->addCheckErrSpan('str');
            break;
