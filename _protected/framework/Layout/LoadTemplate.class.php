...
class LoadTemplate
{
    ...
    public function tpl()
    {
        if (!empty($this->_sUserTpl) && $this->_oConfig->load(PH7_PATH_TPL . $this->_sUserTpl . PH7_DS . PH7_CONFIG . PH7_CONFIG_FILE)) {
            ...
            if ($this->_oConfig->load(PH7_PATH_TPL . $this->_sDefaultTpl . PH7_DS . PH7_CONFIG . PH7_CONFIG_FILE)) {
                $this->_sTplName = $this->_sDefaultTpl;
            } else {
                if ($this->_oConfig->load(PH7_PATH_TPL . PH7_DEFAULT_THEME . PH7_DS . PH7_CONFIG . PH7_CONFIG_FILE)) {
